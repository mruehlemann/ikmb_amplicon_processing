...
#mergers1 <- mergePairs(dadaFs, derepFs, dadaRs, derepRs, verbose=10, justConcatenate=T)
...
## Assign taxonomy
###################
taxHS <- assignTaxonomy(seqtab.nochim, "/ifs/data/nfs_share/sukmb276/Microbiome/clean_data_from_dada2/reference_data/sh_general_release_dynamic_02.02.2019.fasta", multithread=threads,tryRC=T) ## CHANGE to directory and pertinent database
